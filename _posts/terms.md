...
id: "https://dttlib.com/terms/index.html"
...
name: "Terms"
permalink: "https://dttlib.com/terms/index.html"
rating: "general"
...
url: "https://dttlib.com/terms/index.html"
viewport: "width=device-width, initial-scale=1, shrink-to-fit=no"

# RSS - The RSS feed front matter (YAML).

atom_link: "https://dttlib.com/terms/rss.xml"
...
item_guid: "https://dttlib.com/terms/rss.xml"
item_link: "https://dttlib.com/terms/rss.xml"
...
twitter_url: "https://dttlib.com/terms/index.html"

# Humans.txt - The Humans.txt front matter (YAML).

author_website: "https://dttlib.com/terms/index.html"
...
the website located at <https://dttlib.com/> (the "Website").
...
remain the exclusive property of DateTime (DTT). This Website is protected
by United States and international copyright, trademark, and other laws.

### Links to Other Sites and to the DateTime (DTT) Site

Our Website may contain links to third-party Web sites ("Linked Sites") or
services that are not owned or controlled by DateTime (DTT). These Linked
Sites are provided solely as a convenience to our visitors.

DateTime (DTT) has no control over and assumes no responsibility for the
...
DATETIME (DTT) DOES NOT PROMISE THAT THE SITE OR ANY CONTENT, SERVICE OR
...
DATETIME (DTT) CANNOT ENSURE THAT ANY FILES OR OTHER DATA YOU DOWNLOAD FROM
THE SITE WILL BE FREE OF VIRUSES OR CONTAMINATION OR DESTRUCTIVE FEATURES.
DATETIME (DTT) ANY AND ALL LIABILITY FOR THE ACTS, OMISSIONS AND CONDUCT OF
ANY THIRD PARTIES IN CONNECTION WITH OR RELATED TO YOUR USE OF THE SITE AND/OR
ANY DATETIME (DTT) SERVICES. IN NO EVENT SHALL DATETIME (DTT), NOR ITS
...
DateTime (DTT)’s [Privacy Policy](/privacy/index.html) applies to use of
